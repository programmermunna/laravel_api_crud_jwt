...
class UserApiController extends Controller
{
    ...
    public function AddUser(Request $request){
        ...
        if($header==''){
            ...
            if($header=='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwiZW1haWwiOiJwcm9ncmFtbWVybXVubmFAZ21haWwuY29tIiwiaWF0IjoxNTE2MjM5MDIyfQ.Al6ar03o_DKlYhCndeVdMkJQ5L4JcSEsFux7NMbvwZY'){
                $users = $request->all();
                $rules = [
                    'name'=>'required',
